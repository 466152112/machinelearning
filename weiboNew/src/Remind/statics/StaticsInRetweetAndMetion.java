...
import Remind.preproccess.GetUserFromTheOrginalTweetNetwork;
...
//		useravl = BaseUitl.addTagToUser(useravl, tagFile);
	...
	public void run(AvlTree<User> useravl,
			...
			String path) {
		GetUserFromTheOrginalTweetNetwork temp = new GetUserFromTheOrginalTweetNetwork();
		String useridFile = path + "userid/alluserid.txt";
		Set<Long> useridSet = temp.getAllUserid(useridFile, path);
