 ...
 * 
 */
public class CopyOfDoubanSocaiMF {
	...
	public static void main(String[] args) {
		CopyOfDoubanSocaiMF main = new CopyOfDoubanSocaiMF();
		...
		protected void compute() {
			...
			for (int i = 0; i < 5; i++) {
				...
				SocialMF1 socialMF1 = new SocialMF1(featureWise, trainRating,
						testRating, friendPCC, itemidList,useridList, 100, 0.05, 0.001,
						0.001,i);
				socialMF1.IterBySGD();
...
//						+ "5-cross/" + i + "train.txt");
				SocialMF2 socialMF2 = new SocialMF2(featureWise, trainRating,
						testRating, friendPCC, itemidList,useridList, 100, 0.001, 0.001,
						0.001,i);
				socialMF2.IterBySGD();
			}
		}
