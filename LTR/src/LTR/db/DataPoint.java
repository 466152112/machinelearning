...
public abstract class DataPoint {
	...
	public static int MAX_FEATURE = 20;
	...
	protected float[] fVals = null; //fVals[0] is un-used. Feature id MUST start from 1 特征值保存向量
	
	//helper attributes
	protected int knownFeatures; // number of known feature values 用于增加和删除特征
