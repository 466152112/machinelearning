...
public class AdaRank extends Ranker {
	...
	public void init()
	{
		...
		tolerance=cf.getDouble("tolerance")<0?tolerance:cf.getDouble("tolerance");
		trainWithEnqueue=cf.getString("AdaRank.noeq").equals("unspecified")?trainWithEnqueue:false;
		maxSelCount=cf.getInt("AdaRank.max")<1?maxSelCount:cf.getInt("AdaRank.max");
