...
public class RankNet extends Ranker {
	...
	/**
	 *连接各层的神经元 
	 *@create_time：2015年1月8日下午7:17:52
	 *@modifie_time：2015年1月8日 下午7:17:52
	 ...
	 * @param targetLayer
	 * @param targetNeuron
	 *@create_time：2015年1月8日下午7:19:23
	 *@modifie_time：2015年1月8日 下午7:19:23
	 ...
	 * 向前传播
	 * @param i
	 *@create_time：2015年1月8日下午7:24:05
	 *@modifie_time：2015年1月8日 下午7:24:05
	 ...
	 * @param rl
	 * @return
	 *@create_time：2015年1月8日下午7:29:31
	 *@modifie_time：2015年1月8日 下午7:29:31
	 ...
	 * @param pairMap
	 * @param pairWeight
	 *@create_time：2015年1月8日下午7:29:36
	 *@modifie_time：2015年1月8日 下午7:29:36
	 ...
	 * @param o1
	 * @param o2 
	 * @param targetValue 真实目标值
	 * @return 交叉熵 
	 *@create_time：2015年1月8日下午7:44:23
	 *@modifie_time：2015年1月8日 下午7:44:23
	...
	/**
	 * 计算loss 值
	 *@create_time：2015年1月8日下午7:45:22
	 *@modifie_time：2015年1月8日 下午7:45:22
	...
	{
		//迭代次数 若小于1怎使用默认值
		nIteration = cf.getInt("round")<1?nIteration:cf.getInt("round");
		//网络层数
		nHiddenLayer = cf.getInt("RankNet.layer")<1?nHiddenLayer:cf.getInt("RankNet.layer");
		
		nHiddenNodePerLayer = cf.getInt("RankNet.node")<1?nHiddenNodePerLayer:cf.getInt("RankNet.node");
		learningRate = cf.getDouble("RankNet.lr")<0?learningRate:cf.getDouble("RankNet.lr");
	...
	public void learn()
	{
		...
		for(int i=1;i<=nIteration;i++)
		{
			...
			for (MetricScorer oneScorer : scorers_4_see) {
				scores_value_4_see.add(oneScorer.score(rank(samples)));
			}
			estimateLoss();
			...
			if(i % 1 == 0)
			{
				...
				for (double scoreValue : scores_value_4_see) {
					PRINT(new int[]{9}, new String[]{SimpleMath.round(scoreValue, 4)+""});
				}
				scores_value_4_see=new ArrayList<>();
				...
				if(validationSamples != null)
				{
					...
					for (MetricScorer oneScorer : scorers_4_see) {
						scores_value_4_see.add(oneScorer.score(rank(validationSamples)));
					}
					for (double scoreValue : scores_value_4_see) {
						PRINT(new int[]{9}, new String[]{SimpleMath.round(scoreValue, 4)+""});
					}
	...
	public void printParameters()
	{
		PRINTLN("");
		PRINTLN("");
		PRINTLN("[+] "+this.name()+"'s Parameters:");
