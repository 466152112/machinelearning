 ...
 *    
 */
public class Influence_Based_Ranker extends Ranker {
	/* (non-Javadoc)
	 * @see LTR.learning.Ranker#init()
	 */
	final int Influence_feature_index=11;
	@Override
	public void init() {
	...
	public Ranker clone() {
		// TODO Auto-generated method stub
		return new Influence_Based_Ranker();
	}
	...
	public void loadFromString(String fullText) {
		// TODO Auto-generated method stub
		System.out.println("Influence_Based_Ranker not model");
		System.exit(0);
	}
	...
	{
		return p.getFeatureValue(Influence_feature_index);
	}
}
