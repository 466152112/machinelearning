 ...
 *    
 */
public class Bond_Based_Ranker extends Ranker {
	/* (non-Javadoc)
	 * @see LTR.learning.Ranker#init()
	 */
	final int Bond_Based_index=5;
	@Override
	public void init() {
	...
	{
		return p.getFeatureValue(Bond_Based_index);
	}
}
