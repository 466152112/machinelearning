 ...
 * @class_describe锛�
 * @creator锛歾houge
 * @create_time锛�014骞�鏈�2鏃�涓嬪�?:57:22
 * @modifier锛歾houge
 * @modified_time锛�014骞�鏈�2鏃�涓嬪�?:57:22
 * @modified_note锛�
 * @version
 * 
 */
public class ReadUtil<T> {
	 ...
	 * @modifie_time锛�014骞�鏈�2鏃�涓嬪�?:57:19
	 */
	 ...
	 * @modifie_time锛�014骞�鏈�1鏃�涓嬪�?:59:38
	 */
	 ...
	 * @modifie_time锛�014骞�鏈�1鏃�涓嬪�?:59:38
	 */
	public Set<Long> readSetFromFile_in_long(String fileName) {
		
		Set<Long> resultArrayList = new HashSet();
		try {
			BufferedReader bufferedReader = new BufferedReader(new FileReader(
					new File(fileName)));
			String oneLine = bufferedReader.readLine();
	 ...
	 * @return
	 * @create_time�?014�?�?日下�?:03:22
	 * @modifie_time�?014�?�?�?下午6:03:22
	 */
