 ...
 * @class_describe��   
 * @creator��zhouge   
 * @create_time��2014��12��7�� ����2:34:36   
 * @modifier��zhouge   
 * @modified_time��2014��12��7�� ����2:34:36   
 * @modified_note��   
 * @version    
 *    
 */
...
//					.getuserIdAndNameMapFromprofileFile(profileFile);
		...
		/**
		 * 
		 *@create_time��2014��12��7������2:52:40
		 *@modifie_time��2014��12��7�� ����2:52:40
		...
		/**
		 * 读取用户id+content格式数据，把数据写入文件从lda能处理的格式
		 *@create_time：2014年12月15日下午6:16:49
		 *@modifie_time：2014年12月15日 下午6:16:49
		 ...
		 * @param TargetFile
		 * 把数据写入文件从lda能处理的格式
		 *@create_time��2014��12��7������10:45:57
		 *@modifie_time��2014��12��7�� ����10:45:57
		 ...
		 * @param filename 
		 *  把键和值输入到文件中
		 *@create_time：2014年12月15日下午6:15:09
		 *@modifie_time：2014年12月15日 下午6:15:09
