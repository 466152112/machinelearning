...
//		String sourcePath = "J:/workspacedata/weiboNew/data/2012/content/";
		...
		useravl = BaseUitl.addProfileName(useravl, profileFile);
	 ...
	 * @param path
	 * @param useravl
	 *@create_time��2014��11��4������9:29:14
	 *@modifie_time��2014��11��4�� ����9:29:14
	 ...
	 * @param useravl
	 * @return
	 * @create_time��2014��11��4������8:40:28
	 * @modifie_time��2014��11��4�� ����8:40:28
	 */
	public int[] retweetRouteTimeSequence(Retweetlist oneList,
		...
		for (int i = 0; i < listRetweet.size(); i++) {
			...
			if (onePairTweet.getContent().indexOf("//@") != -1) {
				...
				List<String> routeNameList = filter
						.getRouteName(onePairTweet.getContent());
